...
public class Student extends User implements iMenu {
    ...
    public void menu() {
        ...
        //Button styles
        borrowedBookButton.setStyle("-fx-background-color: #333333; -fx-text-fill: white;");
        borrowBookButton.setStyle("-fx-background-color: #333333; -fx-text-fill: white;");
        returnBookButton.setStyle("-fx-background-color: #333333; -fx-text-fill: white;");
    ...
    public static void showBorrowedBooks() {
        ...
        gridPane.setStyle("-fx-background-color: black;"); // Set background color to black
    ...
    public static void returnBooks() {
        ...
        bookIdLabel.setStyle("-fx-text-fill: white;");
        ...
        returnButton.setStyle("-fx-background-color: #333333; -fx-text-fill: white;");
